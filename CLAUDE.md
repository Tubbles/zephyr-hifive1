...
thing you edit. Make sure to read DESIGN.md to understand the project. LOG.md is
a grep-able log of bring-up learnings and decisions (boot-capture gotchas, west
module dependencies, DirectXIP and WiFi findings) that the commits and code do
not capture; skim it before debugging hardware or the build.
